...
type IndicatorConfigMap = Record<string, IndicatorParamConfig[]>

const indicatorConfigs: IndicatorConfigMap = {
  AO: [
...
export function getIndicatorConfig(name: string): IndicatorParamConfig[] {
  return indicatorConfigs[name] ?? []
}

export default indicatorConfigs
