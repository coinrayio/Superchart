...
export const defaultScriptLanguage: ScriptLanguageDefinition = {
  ...
  builtinFunctions: [
    // Pine Script Declaration Functions (v6)
    ...
    // Input Functions (Pine Script v5)
    ...
    // Plotting Functions
    { name: 'plot', description: 'Plot a series on the chart', parameters: [{ name: 'series', type: 'series' }, { name: 'title', type: 'string', optional: true }, { name: 'color', type: 'color', optional: true }, { name: 'linewidth', type: 'int', optional: true }, { name: 'style', type: 'string', optional: true }], returnType: 'plot' },
    { name: 'plotshape', description: 'Plot shapes', parameters: [{ name: 'series', type: 'bool' }, { name: 'title', type: 'string', optional: true }, { name: 'style', type: 'string', optional: true }, { name: 'location', type: 'string', optional: true }, { name: 'color', type: 'color', optional: true }], returnType: 'void' },
    { name: 'plotchar', description: 'Plot character', parameters: [{ name: 'series', type: 'bool' }, { name: 'char', type: 'string', optional: true }, { name: 'location', type: 'string', optional: true }, { name: 'color', type: 'color', optional: true }], returnType: 'void' },
    { name: 'plotarrow', description: 'Plot arrows', parameters: [{ name: 'series', type: 'series' }, { name: 'title', type: 'string', optional: true }, { name: 'colorup', type: 'color', optional: true }, { name: 'colordown', type: 'color', optional: true }], returnType: 'void' },
    { name: 'plotcandle', description: 'Plot candles', parameters: [{ name: 'open', type: 'series' }, { name: 'high', type: 'series' }, { name: 'low', type: 'series' }, { name: 'close', type: 'series' }], returnType: 'void' },
    { name: 'hline', description: 'Draw horizontal line', parameters: [{ name: 'price', type: 'float' }, { name: 'title', type: 'string', optional: true }, { name: 'color', type: 'color', optional: true }, { name: 'linestyle', type: 'string', optional: true }], returnType: 'hline' },
    { name: 'fill', description: 'Fill between two plots', parameters: [{ name: 'plot1', type: 'plot' }, { name: 'plot2', type: 'plot' }, { name: 'color', type: 'color', optional: true }, { name: 'title', type: 'string', optional: true }], returnType: 'void' },
    { name: 'bgcolor', description: 'Set background color', parameters: [{ name: 'color', type: 'color' }, { name: 'offset', type: 'int', optional: true }], returnType: 'void' },
    { name: 'barcolor', description: 'Set bar color', parameters: [{ name: 'color', type: 'color' }, { name: 'offset', type: 'int', optional: true }], returnType: 'void' },
