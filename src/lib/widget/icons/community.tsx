export default () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="44" height="44" fill="currentColor">
    ...
    <path fill="currentColor" d="M27 31c0 .336-.011.67-.033 1h-1.002c.023-.33.035-.664.035-1 0-7.732-6.268-14-14-14-.336 0-.67.012-1 .035v-1.002c.33-.022.664-.033 1-.033 8.284 0 15 6.716 15 15Z"></path>
