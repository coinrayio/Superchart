export default () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="currentColor">
    ...
    <path d="M8 18h1v3h-1z" id="Path"></path>
    <path d="M8 9h1v5h-1z"></path>
    <path fillRule="nonzero" d="M8 18h1v-4h-1v4zm-1-5h3v6h-3v-6z" id="Rectangle-44"></path>
    <path d="M18 16h1v3h-1z" id="Path"></path>
    <path d="M18 3h1v6h-1z"></path>
    <path fillRule="nonzero" d="M18 16h1v-7h-1v7zm-1-8h3v9h-3v-9z" id="Rectangle-44"></path>
